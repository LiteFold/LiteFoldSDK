...
from ..types import api_key_create_params, api_key_revoke_params
...
class APIKeysResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            "/api-keys",
            body=maybe_transform({"description": description}, api_key_create_params.APIKeyCreateParams),
    ...
    def revoke(
        ...
        *,
        ...
        return self._post(
            "/api-keys/revoke",
            body=maybe_transform({"api_key_id": api_key_id}, api_key_revoke_params.APIKeyRevokeParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncAPIKeysResource(AsyncAPIResource):
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/api-keys",
            body=await async_maybe_transform({"description": description}, api_key_create_params.APIKeyCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=APIKeyCreateResponse,
    ...
    async def revoke(
        ...
        *,
        ...
        return await self._post(
            "/api-keys/revoke",
            body=await async_maybe_transform({"api_key_id": api_key_id}, api_key_revoke_params.APIKeyRevokeParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=APIKeyRevokeResponse,
